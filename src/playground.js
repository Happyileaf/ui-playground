...
(function () {
  ...
  const cases = [
    ...
    },
    {
      ...
      description: 'Dynamic particle flow field generated by 3D Perlin noise with continuous vector field evolution.',
      files: ['index.html', 'style.css', 'script.js'],
      tags: ['perlin-noise', 'generative-art', 'particles', 'flow-field']
    },
    {
      id: 'button',
